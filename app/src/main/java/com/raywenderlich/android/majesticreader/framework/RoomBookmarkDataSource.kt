...
import com.raywenderlich.android.majesticreader.framework.db.BookmarkDao
...
class RoomBookmarkDataSource(context: Context) : BookmarkDataSource {
    ...
    private val bookmarkDao by lazy { MajesticReaderDatabase.getInstance(context).bookmarkDao() }
